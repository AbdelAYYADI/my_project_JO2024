 ...
 */
final class Version20250908184947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, sport_id INT NOT NULL, name VARCHAR(30) NOT NULL, title VARCHAR(100) NOT NULL, date_event DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', program_event JSON NOT NULL COMMENT \'(DC2Type:json)\', location VARCHAR(120) NOT NULL, INDEX IDX_3BAE0AA7AC78BCF8 (sport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
